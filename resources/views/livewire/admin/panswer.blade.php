        ...
        <x-slot name="form">
            ...
            <div class="flex flex-col w-full my-2">
                <div class="p-2 m-1 border border-gray-200 rounded-lg">
                    <div>Pilih Tipe Jawaban</div>
                    <div class="relative flex items-center h-10 p-1 mx-4 my-8 rounded-full">
                        <button wire:click="selectType(1)"
                            class=" items-center w-full flex justify-center @if($type == 1) bg-indigo-600 text-white @else text-gray-600 @endif  border border-gray-300 mx-2 rounded-full  h-10 shadow">
                            <span>Type 1</span>
                        </button>
                        <button wire:click="selectType(2)"
                            class="@if($type == 2) bg-indigo-600 text-white @else text-gray-600 @endif items-center w-full flex justify-center border border-gray-300 mx-2 rounded-full  shadow h-10 duration-150 ease-in-out">
                            <span>Type 2</span>
                        </button>
                        <button wire:click="selectType(3)"
                            class="@if($type == 3) bg-indigo-600 text-white @else text-gray-600 @endif items-center w-full flex justify-center border border-gray-300 mx-2 rounded-full text-gray-600 shadow h-10 duration-150 ease-in-out">
                            <span>Type 3</span>
                        </button>
                        <button wire:click="selectType(4)"
                            class="@if($type == 4) bg-indigo-600 text-white @else text-gray-600 @endif items-center w-full flex justify-center border border-gray-300 mx-2 rounded-full text-gray-600 shadow h-10 duration-150 ease-in-out">
                            <span>Type 4</span>
                        </button>
                    </div>
                </div>
                @if ($type == 1)
                <div class="p-2 m-1 border border-gray-200 rounded-lg">
                    <div class="mt-4 mb-2">Isi Data Jawaban</div>
                    <div class="flex mb-4 ">
                    ...
                    <div class="relative flex items-center h-10 p-1 mx-4 mt-4 rounded-full">
                        <button wire:click="selectTypeAnswer('text')"
                            class=" items-center w-full flex justify-center @if($typeAnswer == 'text') bg-indigo-600 text-white @else text-gray-600 @endif  border border-gray-300 mx-2 rounded-full  h-10 shadow">
                            <span>Text</span>
                        </button>
                        <button wire:click="selectTypeAnswer('picture')"
                            class="@if($typeAnswer == 'picture') bg-indigo-600 text-white @else text-gray-600 @endif items-center w-full flex justify-center border border-gray-300 mx-2 rounded-full  shadow h-10 duration-150 ease-in-out">
                            <span>Picture</span>
                        </button>
                        <button wire:click="selectTypeAnswer('audio')"
                            class="@if($typeAnswer == 'audio') bg-indigo-600 text-white @else text-gray-600 @endif items-center w-full flex justify-center border border-gray-300 mx-2 rounded-full text-gray-600 shadow h-10 duration-150 ease-in-out">
                            <span>Audio</span>
                        </button>
                    </div>
                    ...
                    <div class="col-span-6 mt-2 sm:col-span-4">
                        ...
                        <div>
                            @if ($pict != null && $typeAnswer == 'picture')
                            <div
