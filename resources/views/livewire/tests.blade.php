<div>
    {{-- Title --}}
    @push('pageTitle', $materi->title. " - Test - ")
    {{-- Header --}}
    <x-slot name="header">
        ...
        <div class="flex flex-col justify-center items-center">
            <div class="w-10/12 flex flex-col p-5">
                ...
                <div class="flex flex-col justify-center items-center h-96">
                    <div><img src="{{ asset('svg/tid.svg') }}"></div>
                    <div class="text-2xl">SCORE {{ $score->score }}</div>
                </div><br />
                @else
                ...
                <x-input id="writeAnswer" type="text" class="mt-8 p-2 block w-full " wire:model="writeAnswer" required
    ...
    <div class="fixed bottom-0 w-full z-10">
        <div class="bg-white w-full flex justify-center flex-col items-center">
            ...
            <div class="flex justify-between items-center text-xl w-10/12 mb-3 pb-6">
                <div class="flex">
                    <div class="text-lg uppercase mt-4 border-2 py-1 px-6 rounded-full border-blue-500 mx-1">Test
                    </div>
                    <div class="text-lg uppercase mt-4 border-2 py-1 px-6 rounded-full border-blue-500 mx-1">
                        {{ $no+1 }}/{{ count($tests) }}
                    </div>
                </div>
